        ...
        <div class="flex flex-wrap">
          ...
          >
            ...
            <p class="leading-relaxed text-base mb-4">
              ...
              immer wieder etwas ganz Besonderes zu bieten. Bei architektur INFORM buchen
              Sie mich als Planerin, Organisatorin und Leiterin Ihrer
              Architektur-Exkursion. Die Destination, der Termin und die Gruppengrösse
              sind nach Wunsch frei wählbar.
            </p>
          </div>
          <div
            class="xl:w-1/4 lg:w-1/2 md:w-full px-8 py-6 border-l-2 border-gray-200 border-opacity-60"
      ...
      <div class="max-w-screen-xl px-4 md:px-8 mx-auto">
        <div class="grid md:grid-cols-2 gap-8 lg:gap-12">
          ...
          <div>
            <div class="h-64 md:h-auto overflow-hidden rounded-md shadow-lg">
              <img
                src="https://www.architekturinform.com/media/filer_public_thumbnails/filer_public/95/11/95117b2e-a68f-4d10-a0f0-2b50dd3f45a4/498.jpg__800x600_q95_crop-False.jpg"
                loading="lazy"
                alt=""
                class="w-full h-full object-cover object-center my-0"
              />
